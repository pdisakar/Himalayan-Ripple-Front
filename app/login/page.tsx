...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Store token in localStorage (matching admin layout check)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-primary/20 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md p-8 bg-white backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-lg bg-white border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/50 outline-none transition-all"
