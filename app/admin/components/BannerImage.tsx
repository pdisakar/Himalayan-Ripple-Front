                ...
                <div className="space-y-3">
                    {imageUrl ? (
                        ...
                        <div className="relative group w-full">
                            ...
                            <div className="relative bg-white dark:bg-gray-900 rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700 group-hover:border-transparent transition-all duration-300 overflow-hidden">
                                <input
                                    type="file"
                                    id={inputId}
                                    accept="image/*"
                                ...
                                <label
                                    htmlFor={inputId}
                                    className="cursor-pointer flex flex-col items-center justify-center gap-4 p-12 hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition-colors"
                                >
