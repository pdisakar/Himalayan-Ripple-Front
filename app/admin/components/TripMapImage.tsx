...
export function TripMapImage({
    ...
    return (
        <div className="space-y-6 p-6 bg-white/50 backdrop-blur-sm rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300">
            {/* Image Upload/Preview without aspect ratio constraint */}
            <div>
                ...
                <div className="space-y-3">
                    {imageUrl ? (
                        <div className="group relative w-full max-w-md mx-auto rounded-2xl overflow-hidden shadow-lg transition-transform duration-300 hover:scale-[1.02]">
                        ...
                        <div className="relative group w-full max-w-md mx-auto">
                            ...
                            <div className="relative min-h-[200px] bg-white rounded-xl border-2 border-dashed border-gray-200 group-hover:border-transparent transition-all duration-300 overflow-hidden">
                                <input
                                    type="file"
                                    id={inputId}
                                    accept="image/*"
                                ...
                                <label
                                    htmlFor={inputId}
                                    className="cursor-pointer h-full flex flex-col items-center justify-center gap-4 p-6 hover:bg-gray-50/50 transition-colors min-h-[200px]"
                                >
            ...
            <div className="grid grid-cols-1 gap-4">
                <div className="group">
                    ...
                    <input
                        ...
                        placeholder="Describe the trip map for SEO..."
